...
function Test() {
    const questions = ['When I spend some time hanging out with my friends or relatives for a coffee, I often show empathy towards them when listening to their perspectives and feelings.'
            ...
            <div>
                ...
                <div>
                    <div className='d-flex flex-col justify-content-center'>
                        {question === 'Are you ready to discover your personality?' || counter > questions.length ? (
                            <div></div>
                        ) : (
                            <div>
                                <div id='test'>
                        ...
                        {question === 'Are you ready to discover your personality?' ? (
                            <button type="submit" className='btn btn-dark' onClick={increment}>Begin</button>
                        ) : (
                            <div>
